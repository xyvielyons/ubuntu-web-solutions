...
export default function HeroSection() {
   ...
   return (
      <div className="bg-background relative flex size-full w-full overflow-hidden justify-center items-center rounded-lg md:shadow-sm h-[500px] md:h-[600px] p-2" id="Home">
