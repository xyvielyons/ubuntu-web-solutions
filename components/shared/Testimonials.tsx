...
const Testimonials = () => {
  return (
    <div className='px-[8px] space-y-4 md:px-[16px] py-[32px] flex flex-col gap-2 md:flex-row justify-center items-center border-b-[1px] border-gray-100 dark:border-gray-800' id="Testimonials">
